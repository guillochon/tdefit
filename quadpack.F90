...
recursive subroutine qag ( f, a, b, epsabs, epsrel, key, result, abserr, neval, ier )
...
recursive subroutine qage ( f, a, b, epsabs, epsrel, key, limit, result, abserr, neval, &
  ier, alist, blist, rlist, elist, iord, last )
...
recursive subroutine qagi ( f, bound, inf, epsabs, epsrel, result, abserr, neval, ier )
...
recursive subroutine qagp ( f, a, b, npts2, points, epsabs, epsrel, result, abserr, &
  neval, ier )
...
recursive subroutine qags ( f, a, b, epsabs, epsrel, result, abserr, neval, ier )
...
recursive subroutine qawc ( f, a, b, c, epsabs, epsrel, result, abserr, neval, ier )
...
recursive subroutine qawce ( f, a, b, c, epsabs, epsrel, limit, result, abserr, neval, &
  ier, alist, blist, rlist, elist, iord, last )
...
recursive subroutine qawf ( f, a, omega, integr, epsabs, result, abserr, neval, ier )
...
recursive subroutine qawfe ( f, a, omega, integr, epsabs, limlst, limit, maxp1, &
  result, abserr, neval, ier, rslst, erlst, ierlst, lst, alist, blist, &
  rlist, elist, iord, nnlog, chebmo )
...
recursive subroutine qawo ( f, a, b, omega, integr, epsabs, epsrel, result, abserr, &
  neval, ier )
...
recursive subroutine qaws ( f, a, b, alfa, beta, integr, epsabs, epsrel, result, &
  abserr, neval, ier )
...
recursive subroutine qawse ( f, a, b, alfa, beta, integr, epsabs, epsrel, limit, &
...
recursive subroutine qc25c ( f, a, b, c, result, abserr, krul, neval )
...
recursive subroutine qc25o ( f, a, b, omega, integr, nrmom, maxp1, ksave, result, &
...
recursive subroutine qc25s ( f, a, b, bl, br, alfa, beta, ri, rj, rg, rh, result, &
...
recursive subroutine qcheb ( x, fval, cheb12, cheb24 )
...
recursive subroutine qextr ( n, epstab, result, abserr, res3la, nres )
...
recursive subroutine qfour ( f, a, b, omega, integr, epsabs, epsrel, limit, icall, &
...
recursive subroutine qk15 ( f, a, b, result, abserr, resabs, resasc )
...
recursive subroutine qk15i ( f, boun, inf, a, b, result, abserr, resabs, resasc )
...
recursive subroutine qk15w ( f, w, p1, p2, p3, p4, kp, a, b, result, abserr, resabs, &
  resasc )
...
recursive subroutine qk21 ( f, a, b, result, abserr, resabs, resasc )
...
recursive subroutine qk31 ( f, a, b, result, abserr, resabs, resasc )
...
recursive subroutine qk41 ( f, a, b, result, abserr, resabs, resasc )
...
recursive subroutine qk51 ( f, a, b, result, abserr, resabs, resasc )
...
recursive subroutine qk61 ( f, a, b, result, abserr, resabs, resasc ) 
...
recursive subroutine qmomo ( alfa, beta, ri, rj, rg, rh, integr )
...
recursive subroutine qsort ( limit, last, maxerr, ermax, elist, iord, nrmax )
